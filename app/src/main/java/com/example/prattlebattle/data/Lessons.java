...
public class Lessons {
    ...
    private final static Lesson lesson2 = new Lesson(2, "Lesson 2: Types of listening to focus on",
            new LessonSegment[]{
                    ...
                    new LessonSegment(3, "Ignoring - the worst kind. Doesn’t even involve listening.",  R.raw.a3),
                    new LessonSegment(4, " Pretending - acting as if you are listening but actually paying attention to something else. Certainly not an effective type of listening as it still makes the other party feel ignored.",  R.raw.a4),
            }
    );
